...
public static class TerritoryData
{
    ...
    public static readonly List<Territory> AllTerritories = new List<Territory>
    {
        ...
        new Territory { Id = "SouthAfrica", Name = "South Africa", Nation = null, CityType = CityType.None },
        new Territory { Id = "EastAfrica", Name = "East Africa", Nation = null, CityType = CityType.None },
